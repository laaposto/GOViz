...
public class TopDecisionsVotedUniversities extends HttpServlet {
            ...
            try {
                Statement stmt = con.createStatement();
                 ...
                 ResultSet rs = stmt.executeQuery(
                        "SELECT * FROM desicionsuniv WHERE ada =('"+ada+"');");
...
"UPDATE desicionsuniv SET votes ='"+count+"' WHERE ada='"+ada+"';");
 res.getWriter().write("OK");
                }
                        else{

                        int updateCount = stmt.executeUpdate(
"INSERT INTO desicionsuniv VALUES ('"+ada+"',1);");
                         res.getWriter().write("OK");
                        }
