...
@WebServlet(name = "ParseTagMinistries", urlPatterns = {"/ParseTagMinistries"})
public class ParseTagMinistries extends HttpServlet {
...
double[] lati = {
    38.175, 38.274, 37.572, 38.275, 37.679, 37.872, 37.775, 37.681, 37.971, 37.580,
    37.877, 38.081, 38.049, 38.209, 37.881, 37.771
};

double[] longi ={
    23.436, 23.433, 23.832, 23.736, 23.940, 23.732, 23.928, 23.429, 23.742, 23.700,
    24.100, 23.941, 23.432, 23.332, 23.983, 23.542
};
...
SimpleDateFormat sdf=new SimpleDateFormat("dd-MM-yyyy");
  ...
  try {
     do{
         if(tagint==0){
is = new URL("http://opendata.diavgeia.gov.gr/api/decisions?output=json&datefrom="+datefrom+"&org=31;30;21;20;19;18;17;16;15;14;11;10;8;6;5;3&type=27&from="+from+"&order=asc").openStream();
                     }
         else{
is = new URL("http://opendata.diavgeia.gov.gr/api/decisions?output=json&tag="+tagint+"&datefrom="+datefrom+"&org=31;30;21;20;19;18;17;16;15;14;11;10;8;6;5;3&type=27&from="+from+"&order=asc").openStream();
