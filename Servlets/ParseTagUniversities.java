...
@WebServlet(name = "ParseTagUniversities", urlPatterns = {"/ParseTagUniversities"})
public class ParseTagUniversities extends HttpServlet {
...
double[] lati = {
38.254, 37.975, 39.674, 40.639, 41.118, 37.975, 40.639, 39.619, 38.628, 41.118,
37.975, 40.639, 40.639, 37.975, 38.899, 37.509, 37.950, 38.254, 40.639, 35.254,
39.674, 39.364, 40.301, 39.107, 37.975, 37.975, 40.639};

double[] longi ={
21.737, 23.736, 20.840, 22.944, 25.405, 23.736, 22.944, 19.919, 21.412, 25.405,
23.736, 22.944, 22.944, 23.736, 22.433, 22.372, 23.641, 21.737, 22.944, 24.491,
20.840, 22.933, 21.785, 26.555, 23.736, 23.736, 22.944};
...
String tagpar=request.getParameter("tagname");
String mytag=tagpar.replaceAll("%20"," ");
...
if(tags[tagcount].equals(mytag)){tagint=tagsuids[tagcount]; break;}
}
...
SimpleDateFormat sdf=new SimpleDateFormat("dd-MM-yyyy");
  ...
  try {
     do{
         if(tagint==0){
is = new URL("http://opendata.diavgeia.gov.gr/api/decisions?output=json&datefrom="+datefrom+"&org=99203044;99203020;99202996;99202922;99202868;99202112;99202041;99202011;53926;99201185;99219608;99219528;99219525;99206927;99206925;99206924;99206922;99206920;99206919;99206917;99206915;99206913;99206912;99206911;99206861;50166;50089&type=27&from="+from+"&order=asc").openStream();
                     }
         else{
is = new URL("http://opendata.diavgeia.gov.gr/api/decisions?output=json&tag="+tagint+"&datefrom="+datefrom+"&org=99203044;99203020;99202996;99202922;99202868;99202112;99202041;99202011;53926;99201185;99219608;99219528;99219525;99206927;99206925;99206924;99206922;99206920;99206919;99206917;99206915;99206913;99206912;99206911;99206861;50166;50089&type=27&from="+from+"&order=asc").openStream();
...
aboutdesicions.toArray(jsons);
            ...
            for (int i = 0; i < aboutdesicions.size(); i++) {
                ...
                int tagval=Integer.parseInt(tag);
