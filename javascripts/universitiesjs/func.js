...
function createmunicipalities(){
    ...
    newa=document.createElement('a');
    newa.setAttribute('href','inneruniv.html?mun='+dimosout[orgcount]);
...
function createmunsintags(){
    ...
    newa=document.createElement('a');
    newa.setAttribute('href','inneruniv.html?mun='+dimosout2[orgcount]);
...
function checkmunicipalities(){
    ...
    var availablemunicipalities = [
                "ΕΛΛΗΝΙΚΟ ΑΝΟΙΧΤΟ","ΕΘΝΙΚΟ ΚΑΙ ΚΑΠΟΔΙΣΤΡΙΑΚΟ","Ε.Π.Ι ΙΩΑΝΝΙΝΩΝ","ΔΙΕΘΝΕΣ ΕΛΛΑΔΟΣ","ΔHΜΟΚΡΙΤΕΙΟ ΘΡΑΚΗΣ","ΓΕΩΠΟΝΙΚΟ ΑΘΗΝΩΝ","ΑΡΙΣΤΟΤΕΛΙΕΟ ΘΕΣΣΑΛΟΝΙΚΗΣ","ΙΟΝΙΟ","ΔΥΤΙΚΗΣ ΕΛΛΑΔΑΣ","ΕΤΑΙΡΕΙΑ ΑΞΙΟΠΟΙΗΣΗΣ ΚΑΙ ΔΙΑΧΕΙΡΙΣΗΣ ΠΕΡΙΟΥΣΙΑΣ ΤΟΥ ΔΗΜΟΚΡΙΤΟΥ ΘΡΑΚΗΣ",
                "ΧΑΡΟΚΟΠΕΙΟ","ΤΑΜΕΙΟ ΔΙΟΙΚΙΣΗΣ ΔΙΑΧΕΙΡΙΣΗΣ ΠΑΝΕΠΙΣΤΗΜΙΑΚΩΝ ΔΑΣΩΝ","ΤΑΜΕΙΟ ΔΙΟΙΚΙΣΗΣ ΔΙΑΧΕΙΡΙΣΗΣ ΑΓΡΟΚΤΗΜΑΤΟΣ ΑΡΙΣΤΟΤΕΛΕΙΟΥ ΘΕΣΣΑΛΟΝΙΚΗΣ","ΠΑΝΤΕΙΟ","ΣΤΕΡΕΑΣ ΕΛΛΑΔΑΣ","ΠΕΛΛΟΠΟΝΗΣΟΥ","ΠΕΙΡΑΙΩΣ","ΠΑΤΡΩΝ","ΜΑΚΕΔΟΝΙΑΣ","ΚΡΗΤΗΣ",
                "ΙΩΑΝΝΙΝΩΝ","ΘΕΣΣΑΛΙΑΣ","ΔΥΤΙΚΗΣ ΜΑΚΕΔΟΝΙΑΣ","ΑΙΓΑΙΟΥ","ΟΙΚΟΝΟΜΙΚΟ ΑΘΗΝΩΝ","ΕΡΕΥΝΗΤΙΚΟ ΠΑΝΕΠΙΣΤΗΜΙΑΚΟ ΙΝΣΤΙΤΟΥΤΟ ΣΥΣΤΗΜΑΤΩΝ ΕΠΙΚΟΙΝΩΝΙΩΝ ΚΑΙ ΥΠΟΛΟΓΙΣΤΩΝ","ΠΑΝΕΠΙΣΤΗΜΙΑΚΗ ΦΟΙΤΙΤΙΚΗ ΛΕΣΧΗ Α.Π.Θ."];
...
function voted(doc){
  ...
  jQuery.ajax({
				type: "GET",
				url: "TopDecisionsVotedUniversities?ada="+doc,
				dataType: "text",
