...
jQuery(document).ready(function(){
			 ...
			 call=jQuery.ajax({
				type: "GET",
				url: "ParseGlobalAllUniversities",
				dataType: "xml",
...
geomap, 'select', function() {
   ...
   var item=clicked[0];
   location.href = "inneruniv.html?mun="+dimosout[item.row];
...
jQuery(document).ready(function(){
			 ...
			 call=jQuery.ajax({
				type: "GET",
				url: "ParseTagUniversities?tagname="+tagnamepar,
				dataType: "xml",
				success: function(xml) {
...
geomap, 'select', function() {
   ...
   var clicked=geomap.getSelection();
   var item=clicked[0];
   location.href = "inneruniv.html?mun="+dimosout2[item.row];
