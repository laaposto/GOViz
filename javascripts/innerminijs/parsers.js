...
jQuery(document).ready(function(){
     			 call=jQuery.ajax({
				type: "GET",
				url: "InnerMunTagMinistries?mun="+mun,
				dataType: "xml",
...
jQuery(document).ready(function(){
     			call=jQuery.ajax({
				type: "GET",
				url: "InnerMunUnitParserMinistries?mun="+mun+"&datefrom="+datefrom+"&dateto="+dateto,
				dataType: "xml",
				success: function(xml) {
...
jQuery(document).ready(function(){
     			call=jQuery.ajax({
				type: "GET",
				url: "InnerMunTagParserMinistries?mun="+mun+"&datefrom="+datefrom+"&dateto="+dateto,
				dataType: "xml",
				success: function(xml) {
...
jQuery(document).ready(function(){
     			call=jQuery.ajax({
				type: "GET",
				url: "InnerMunAfmParserMinistries?mun="+mun+"&datefrom="+datefrom+"&dateto="+dateto,
				dataType: "xml",
				success: function(xml) {
...
jQuery(document).ready(function(){
     			call=jQuery.ajax({
				type: "GET",
				url: "InnerMunDateParserMinistries?mun="+mun+"&datefrom="+datefrom+"&dateto="+dateto,
				dataType: "xml",
				success: function(xml) {
