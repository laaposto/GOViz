...
jQuery(document).ready(function(){
     			 call=jQuery.ajax({
				type: "GET",
				url: "InnerMunTagUniversities?mun="+mun,
				dataType: "xml",
...
jQuery(document).ready(function(){
     			call=jQuery.ajax({
				type: "GET",
				url: "InnerMunUnitParserUniversities?mun="+mun+"&datefrom="+datefrom+"&dateto="+dateto,
				dataType: "xml",
				success: function(xml) {
...
jQuery(document).ready(function(){
     			call=jQuery.ajax({
				type: "GET",
				url: "InnerMunTagParserUniversities?mun="+mun+"&datefrom="+datefrom+"&dateto="+dateto,
				dataType: "xml",
				success: function(xml) {
...
jQuery(document).ready(function(){
     			call=jQuery.ajax({
				type: "GET",
				url: "InnerMunAfmParseruniversities?mun="+mun+"&datefrom="+datefrom+"&dateto="+dateto,
				dataType: "xml",
				success: function(xml) {
...
jQuery(document).ready(function(){
     			call=jQuery.ajax({
				type: "GET",
				url: "InnerMunDateParserUniversities?mun="+mun+"&datefrom="+datefrom+"&dateto="+dateto,
				dataType: "xml",
				success: function(xml) {
