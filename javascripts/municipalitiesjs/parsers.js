...
jQuery(document).ready(function(){
			 ...
			 call=jQuery.ajax({
				type: "GET",
				url: "ParseGlobalAllMunicipalities",
				dataType: "xml",
...
geomap, 'select', function() {
   ...
   var item=clicked[0];
   location.href = "innermun.html?mun="+dimosout[item.row];
...
jQuery(document).ready(function(){
			 ...
			 call=jQuery.ajax({
				type: "GET",
				url: "ParseTagMunicipalities?tagname="+tagnamepar,
				dataType: "xml",
				success: function(xml) {
...
geomap, 'select', function() {
   ...
   var clicked=geomap.getSelection();
   var item=clicked[0];
   location.href = "innermun.html?mun="+dimosout2[item.row];
