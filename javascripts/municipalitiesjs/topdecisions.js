...
/*
ada2gr=textgr.substring(11,22);
ada2=text.substring(11,22);

ada3gr=textgr.substring(22,33);
ada3=text.substring(22,33);

ada4gr=textgr.substring(33,44);
ada4=text.substring(33,44);

ada5gr=textgr.substring(44,55);
ada5=text.substring(44,55);
...
img=document.createElement('img');
a.appendChild(img);
img.setAttribute('src','imgs/download.jpg');
img.setAttribute('id','dlimg');
tr1.appendChild(td);
...
td.appendChild(twitter);
twitter.setAttribute('href', 'http://twitter.com/share');
twitter.setAttribute('class', 'twitter-share-button twitter-tweet');
twitter.setAttribute('data-url',short_url);
twitter.setAttribute('data-count', 'none');
twitter.setAttribute('data-via', 'GOViz');
twitter.setAttribute('data-text', 'ΜΑΖΙ ΤΑ ΦΑΓΑΜΕ ');
twitter.setAttribute('data-related', 'laaposto');
twitter.setAttribute('data-lang', 'gr');
